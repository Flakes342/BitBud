...
def scrape_content(url: str, output_format: str = "text") -> str:
    ...
    if output_format.lower() == "text":
        ...
        # Return a nicely formatted structured representation
        output = []
        ...
        for item in result['structured_content']:
            if item['type'] == 'heading':
                output.append(f"{'#' * item['level']} {item['text']}")
            elif item['type'] == 'paragraph':
        ...
        return f"Unsupported output format: {output_format}. Use 'text', 'json', 'csv', or 'structured'."
